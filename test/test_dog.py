...
def test_seven_card_partial_steps(game_instance):
    ...
    assert game_instance.steps_remaining is None, "Steps remaining should reset after SEVEN card completion."
...
def test_is_path_blocked_logic(game_instance):
    ...
    assert not game_instance.is_path_blocked(10, 15), "Path should not be blocked when clear."
...
def test_card_comparison():
    ...
    assert card2 < card1, "King should be less than Ace."
    assert not (card1 < card3), "Equal cards should not be less than each other."   
